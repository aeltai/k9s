...
func (h *Help) showRk9s() model.MenuHints {
	return model.MenuHints{
		{Mnemonic: "Shift-O", Description: "Rancher UI (mgmt CRDs)"},
		{Mnemonic: "Shift-F", Description: "Fleet UI (fleet CRDs)"},
		{Mnemonic: "Shift-J", Description: "Rancher projects (mgmt)"},
		{Mnemonic: "Shift-U", Description: "Rancher clusters (mgmt)"},
		{Mnemonic: "Shift-K", Description: "Sync kubeconfig (mgmt)"},
		{Mnemonic: "Shift-L", Description: "Longhorn UI (volumes)"},
		{Mnemonic: "Shift-H", Description: "Harvester UI (vm/vmi)"},
		...
		{Mnemonic: "Shift-G", Description: "GitRepo/Longhorn node info"},
		{Mnemonic: "Shift-R", Description: "Reconcile (fleet/longhorn)"},
		{Mnemonic: "Shift-T", Description: "Bundle/trim (fleet/longhorn)"},
		{Mnemonic: "Shift-B", Description: "Snapshots (longhorn)"},
		{Mnemonic: "Shift-S", Description: "VM console (vm/vmi)"},
		{Mnemonic: "Shift-V", Description: "VM VNC (vm/vmi)"},
		...
		{Mnemonic: "Shift-I", Description: "VM guest info / kwctl"},
		{Mnemonic: "m", Description: "VM migrate (vm/vmi)"},
